 ...
 */
class TodoLocalStorageImpl @javax.inject.Inject constructor
    (private val sharedPrefs: SharedPreferences,
     private val calendar: Calendar,
     private val gson: Gson) : TodoStorageInteractor {
         ...
         withContext(Dispatchers.IO) {
            ...
            if (existingItemIndex != -1) {
                ...
                val updatedItem = existingItem
                    .copy(done = isChecked, modificationDate = calendar.timeInMillis)
    ...
    companion object {
        const val TODO_PREFS = "todoPreferencesNames"
